...
Route::middleware('only_admin')->group(function() {
        ...
        Route::get('dashboard', [DashboardController::class, 'index']);
            ...
            Route::get('/books/search', 'BookController@search')->name('search.books');
            Route::get('/books/sort/{field}/{order}', [BookController::class, 'sort'])->name('books.sort');
            ...
            Route::get('book-return', [BookRentController::class, 'saveReturnBook']);
